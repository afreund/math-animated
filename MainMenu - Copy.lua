...
local newAngel = 0
	...
	local bg           = createImage("images/bg_a.png",          _W/2,   _H/2,       1);
    local grass        = createImage("images/grass.png",         _W/2,   _H/1.35,  0.5);
	local pig          = createImage("images/pig.png",           _W/4,   _H/1.25,  0.4);
	local settings     = createImage("images/Settings.png",      _W/6,   _H/2.7,   0.6);
	local rating       = createImage("images/Rating.png",        _W/6,   _H/2,     0.6);
	local more         = createImage("images/More.png",          _W/6,   _H/1.6,   0.6);
	local star_yellow  = createImage("images/star_yellow.png",   _W/4.8, _H/18,    0.4);
    ...
    levelsGroup.x = 0;
	   ...
	   local txt_level
          ...
          for i = 1, 6, 1 do
	      local image_name = "images/Level_" .. i  .. ".png";
	      local level = display.newImage(image_name, 0, 0);
	      level.xScale = 0.8;
	      level.yScale = 0.8;
	      level.x = (level.width *0.8)*i;
	      level.y = _H/2  - level.height/1.8 ;
	      level.alpha = 0.8;
          levelsGroup:insert(level);
      
	      local image_name = "images/txt_Level" .. i  .. ".png";
	      txt_level = display.newImage(image_name, 0, 0);
	      txt_level.xScale = 0.8;
	      txt_level.yScale = 0.8;
	      txt_level.x = (txt_level.width *1.6)*i;
	      txt_level.y = _H/2 - txt_level.height/0.45 ;
	      txt_level.alpha = 1;

...
function new()
	...
	local txt_level4 = display.newImage("images/txt_Level4.png", _W, _H);
	txt_level4:setReferencePoint(display.CenterReferencePoint); 
    txt_level4.x = _W/2 - txt_level4.width/20;
	txt_level4.y = _H/2  - txt_level4.height/0.3;
	txt_level4.xScale = 0.5
	txt_level4.yScale = 0.5
	--]]
	
	 local Text = display.newText("Level 4 ", _W/2, _H/2, native.systemFont, 32)
    Text:setTextColor(255, 100, 0)

...
function new()
   ...
   -- local starsGame_0_Visible     = true
	...
	--thoughtBubble_plus.isVisible = Bubble_plus_Visible 
	...
	-- *************transition
		 ...
		 transition.to(Hand_Help,           {time = 1000, delay = 19000,  alpha = 0});
		 transition.to(Help_N_5,            {time = 1000, delay = 19000,  alpha = 0});
         transition.to(thoughtBubble_plus,  {time = 2000, delay = 19000,  alpha = 0});
		 transition.to(pig,                 {time = 1000, delay = 19000,  x = pos_2_x })
		 
		 
--timer.performWithDelay( 20000, go_to_game,1 )
